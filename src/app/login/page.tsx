...
import { Lock, Smartphone, Mail, Sparkles, AlertCircle, ChevronRight, UserCheck, Shield } from 'lucide-react';
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="pt-4 border-t border-gray-100 space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              <button
                onClick={() => setDemo('volunteer@iskcon.org')}
                className="p-2 rounded-xl bg-amber-50 hover:bg-amber-100 border border-amber-200 text-amber-900 font-semibold flex items-center justify-center space-x-1"
              >
              ...
              <button
                onClick={() => setDemo('admin@iskcon.org')}
                className="p-2 rounded-xl bg-maroon-50 hover:bg-maroon-100 border border-maroon-200 text-maroon-900 font-semibold flex items-center justify-center space-x-1"
              >
